...
public final class ChainedRequestValidator implements RequestValidator {
    private final List<RequestValidator> requestValidators;

    public ChainedRequestValidator(List<RequestValidator> requestValidators) {
        this.requestValidators = ImmutableList.copyOf(requestValidators);
    }
